...
treatment that accounts for overlapping lines and saturation effects. IRIS is vectorized and optimized with jit, i.e. the code is compiled and can be significantly sped-up using GPUs.
